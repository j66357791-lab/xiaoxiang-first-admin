...
import {
  ...
  Upload, Space, message, Divider, Row, Col, Image, Tag
} from 'antd';
import {
  ...
  return (
    <Card title="发布回收商品">
      <Form form={form} layout="vertical" onFinish={handleSubmit}
        initialValues={{
          enableRecycle: true, freeShipping: true, estimatedDays: 3, isActive: true,
      ...
      >
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item name="basePrice" label="基础参考价" rules={[{ required: true }]}>
